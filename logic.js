...
function createFeatures(earthquakeData) {
  ...
  for (var i = 0; i < earthquakeData.length; i++) {
    mag2.push([earthquakeData[i].geometry.coordinates[1],earthquakeData[i].geometry.coordinates[0]])
    ...
    mag1.push(
      ...
      console.log(mag1)
      console.log(mag2)
    var mag = L.layerGroup(mag1);
    
      console.log(mag)
  // Sending our earthquakes layer to the createMap function
  createMap(earthquakes,mag);
